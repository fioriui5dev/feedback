sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("feedback.POFeedack.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias feedback.POFeedack.controller.ListSelector
			 */
			 ...
			 * @return {feedback.POFeedack.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
